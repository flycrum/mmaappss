...
| `mmaappss-marketplaces-cursor-sync.ts` | Syncs plugin content into `.cursor/`: rules as .mdc (with `alwaysApply: true`), commands/skills/agents symlinked. No marketplace.json (Cursor does not support local marketplaces). |
